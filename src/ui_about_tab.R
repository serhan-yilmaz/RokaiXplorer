   ...
   tabsetPanel(id = "aboutTabset", 
       tabPanel(
         ...
         tags$div(
           ...
           about_desc_item("RokaiXplorer is an interactive tool to perform exploratory analysis on phospho-proteomic data with a particular focus on biomarker discovery."),
