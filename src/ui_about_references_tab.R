...
referencesTab <- tabPanel(
  ...
  tags$div(
    ...
    desc_text("Please check out the following manuscript for further information:"),
    paper_txt("Yilmaz, S., Lopes, F. B. T. P., Schlatzer, D., Ayati, M., Chance, M. R., & Koyuturk, M. ", "2024", "Making Proteomics Accessible: RokaiXplorer for interactive analysis of phospho-proteomic data.", "Bioinformatics Advances", "https://doi.org/10.1093/bioadv/vbae077", "vbae077"),
    # paper_txt("Yilmaz, S., Lopes, F. B. T. P., Schlatzer, D., Ayati, M., Chance, M. R., & Koyuturk, M. ", "2023", "Making Proteomics Accessible: RokaiXplorer for interactive analysis of phospho-proteomic data.", "bioRxiv", "https://doi.org/10.1101/2023.08.22.553639", "2023-08"),
    tags$p(""), 
    desc_text("In addition, the following resources are used in this application:"),
